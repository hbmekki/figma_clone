...
const CursorChat = ({ cursor,
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'Enter') {
            const previousMessage = cursorState.mode === CursorMode.Chat ? cursorState.message : null;
            setCursorState({ mode: CursorMode.Chat, previousMessage: previousMessage, message: '' })
